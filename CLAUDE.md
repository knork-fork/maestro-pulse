...
| The card detail modal's "Attached" viewer — fetches an md attachment and renders it, with a copy-raw-to-clipboard button and a "back to card" control | [src/components/AttachmentViewModal.tsx](src/components/AttachmentViewModal.tsx) |
